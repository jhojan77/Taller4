...
import static Exercise3.Number.orderBurbuja;
...
public class Main {
        ...
        public static void main(String[] args) {
            ...
            int arrayRandom [] = new int [random];  //Asignamos tamaño al array con dicho numero aleatoriao  
            //int[] arrayOrderBurbuja =orderBurbuja(arrayRandom);//Llamamos al método para ordenar el array y guardarlo ordenado 
            //int[] arrayOrderQuickSort = orderQuickSort(arrayRandom);
